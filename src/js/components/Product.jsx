    ...
    render: function () {
        return (
            <li data-index={this.props.id} onClick={this.clickHandler} className="Bxz(bb) D(ib) Cur(p) Pos(r) Ta(start) Bg(subtitle)">
                ...
                <h2 className="D(b) Fz(10px) Whs(nw) Ov(h) Tov(e) Maw(130px) P(10px) Ta(c) M(0) Pos(a) End(0) B(0)"><a href="#" className="Td(n) C(subtitle)">{this.props.title}</a></h2>
                <div className="highlight Pos(a) W(100%) H(100%) Op(0) Op(1):h T(0) Start(0)"></div>
            </li>
        )
    }
