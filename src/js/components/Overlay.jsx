    ...
    render: function () {
        return (
            <div className="single-product page Z(100)">
                ...
                <div className="preview-large Bxz(bb) W(760px) H(500px) Pos(f) Mstart(-375px) Mt(-275px) Pe(n) Bg(subtitle) Z(102) Op(0) Trsde(0.4s) T(50%) Start(50%) visible_Op(1) visible_Pe(n) visible_Trsde(1.4s)">
